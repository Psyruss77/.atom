...
import { ImmutableOutput, OnDiskOutput } from "./outputs";
import { ExecutionCount, JSONObject, MultiLineString } from "./primitives";
import { ImmutableNotebook, NotebookRecordParams } from "./structures";
...
export declare function outputToJS(output: ImmutableOutput): OnDiskOutput;
/**
 ...
 */
export declare function cellToJS(immCell: ImmutableCell): Cell;
/**
