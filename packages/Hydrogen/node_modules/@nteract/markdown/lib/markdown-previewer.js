...
exports.MarkdownPreviewer = void 0;
const presentational_components_1 = require("@nteract/presentational-components");
const react_1 = __importDefault(require("react"));
const markdown_render_1 = __importDefault(require("./markdown-render"));
const noop = () => { };
class MarkdownPreviewer extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    shouldComponentUpdate(nextProps) {
        return (this.props.editorFocused !== nextProps.editorFocused ||
    ...
    render() {
        ...
        return this.state && this.state.view ? (react_1.default.createElement("div", { onDoubleClick: this.openEditor, onKeyDown: this.renderedKeyDown, ref: rendered => {
            ...
            react_1.default.createElement(presentational_components_1.Outputs, null,
                react_1.default.createElement(markdown_render_1.default, Object.assign({}, this.props.markdownOptions, { source: source
                        ? source
...
exports.MarkdownPreviewer = MarkdownPreviewer;
